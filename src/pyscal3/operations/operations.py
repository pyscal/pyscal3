...
def repeat_fractional(system, repetitions, ghost = False,
    ...
    x_lo = repetitions[0]*self.boxdims[0]
    x_hi = (repetitions[0]+1)*self.boxdims[0]
    y_lo = repetitions[1]*self.boxdims[1]
    y_hi = (repetitions[1]+1)*self.boxdims[1]
    z_lo = repetitions[2]*self.boxdims[2]
    z_hi = (repetitions[2]+1)*self.boxdims[2]
    xs = 2*repetitions[0] + 1
    ys = 2*repetitions[1] + 1
    zs = 2*repetitions[2] + 1

...
def serialize(system, return_type='dict', outputfile=None):
	...
	if system._structure_dict is not None:
		...
		sample.material.crystal_structure.spacegroup_symbol = prp.get_space_group(system)
		sample.material.crystal_structure.spacegroup_number = prp.get_space_group(system)
		...
		sample.material.crystal_structure.unit_cell.angle = [prp.get_angle(system.box[0], system.box[1]),
	...
	sample.simulation_cell.length = system.box_dimensions
	sample.simulation_cell.vector = system.box
	sample.simulation_cell.angle = [prp.get_angle(system.box[0], system.box[1]),
															prp.get_angle(system.box[1], system.box[2]),
															prp.get_angle(system.box[2], system.box[0])]
